...
public class IfrJurusan extends javax.swing.JInternalFrame {
    ...
    private void showDataJurusan(){
        ...
        try{
            ...
            clearTabelJurusan();
            sqlselect = "select * from tbjurusan order by id_jur asc";
            Statement stat = _Cnn.createStatement();
            ResultSet res = stat.executeQuery(sqlselect);
            while(res.next()){
                vkd_jur = res.getString("id_jur");
    ...
    private void aksiSimpan(){
        ...
        if(btnSimpan.getText().equals("Simpan")){
            sqlinsert = "insert tbjurusan values('"+vkd_jur+"', '"+vjurusan+"')";
        }else{
            sqlinsert = "update tbjurusan set jurusan='"+vjurusan+"' "
                    + "where id_jur='"+vkd_jur+"'";
        }
        try{
    ...
    private void aksiHapus(){
        ...
        int jawab = JOptionPane.showConfirmDialog(this, "Apakah Anda Iingin Menghapus Data : "+vkd_jur,
        ...
        if( jawab == JOptionPane.YES_OPTION){
            try{
                _Cnn = null;
                _Cnn = getCnn.getConnection();
                sqldelete = "delete from tbjurusan where id_jur='"+vkd_jur+"'";
                Statement stat = _Cnn.createStatement();
                stat.executeUpdate(sqldelete);
                JOptionPane.showMessageDialog(this, "Data Berhasil Dihapus","Informasi",JOptionPane.
                        INFORMATION_MESSAGE);
                showDataJurusan(); clearForm(); disableInput();
            }catch(SQLException ex){
                JOptionPane.showMessageDialog(this, "Error method aksiSmpan() :"+ ex);
            }
        }
    ...
    private void initComponents() {
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(txtKdJur, javax.swing.GroupLayout.PREFERRED_SIZE, 149, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(txtJurusan, javax.swing.GroupLayout.DEFAULT_SIZE, 290, Short.MAX_VALUE)
                .addContainerGap())
        );
    ...
    private void btnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnHapusActionPerformed
        if(txtKdJur.getText().equals("")){
            JOptionPane.showMessageDialog(this, "Kode Belum Memilih Data Yang Akan DiHapus","Informasi",
                    JOptionPane.INFORMATION_MESSAGE);
        }else{
                aksiHapus();
         }
...
1.deklarasikan variabel name untuk masing-masing komponent
2.Import file class library yang dibutuhkan
3.deklarasikan objek untuk koneksi database dan class connection
4.deklarasikan variabel-variabel yang dibutuhkan untuk membantu operasi form login
5.buat method untuk operasi pada form
6.buat event masing-masing komponen
7.tambahkan sintak pada method contruktor
