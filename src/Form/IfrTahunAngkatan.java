...
public class IfrTahunAngkatan extends javax.swing.JInternalFrame {
    ...
    private void aksiHapus(){
        int jawab = JOptionPane.showConfirmDialog(this, "Anda Yakin Ingin Menghapus Data Ini ? ID. TA : " +vid_ta,
    ...
    private void initComponents() {
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(txtIdTa, javax.swing.GroupLayout.PREFERRED_SIZE, 149, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(txtThAngkatan, javax.swing.GroupLayout.DEFAULT_SIZE, 290, Short.MAX_VALUE)
                .addContainerGap())
        );
    ...
    private void btnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnHapusActionPerformed
        if(txtIdTa.getText().equals("") || txtIdTa.getText().equals("[ AUTO ]")){
            JOptionPane.showMessageDialog(this,"Pilih Data yang ingin dihapus","Informasi",JOptionPane.INFORMATION_MESSAGE);
        }else{
            aksiHapus();
        }
